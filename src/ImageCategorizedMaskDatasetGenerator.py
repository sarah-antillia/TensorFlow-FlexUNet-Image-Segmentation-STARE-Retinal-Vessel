...
class ImageCategorizedMaskDatasetGenerator(ImageCategorizedMaskDataset):
      ...
      while True:
        ...
        for n, image_file in enumerate(self.image_files):
          ...
          if self.augmentation:
            ...
            # from the original image and mas. 
        ...
        for i in target_numbers:
          ...
          # Here, we convert each rgb_mask in MAsKS arrat to a categorized mask s
  ...
  if __name__ == "__main__":
    try:
      ...
      #generator = ImageCategorizedMaskDatasetGenerator(config_file, dataset=ConfigParser.TRAIN)
      #for i in range(10):
      #  generator.generate()
